...
#define ERYU_INFO
#ifdef ERYU_INFO
#define RECORD_INFO(file_num,format,...)   ERYU_LOG(file_num,format,##__VA_ARGS__)
...
#ifdef ERYU_DEBUG
#define RECORD_LOG(format,...)   ERYU_LOG(0,format,##__VA_ARGS__)
...
extern void ERYU_LOG(int file_num,const char* format, ...);
